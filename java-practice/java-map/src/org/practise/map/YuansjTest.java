...
public class YuansjTest {
  ...
  public static void main(String[] args) {
    ...
    YuansjMap<Object, String> yuansjMap = new org.practise.map.hashmap.achieve.arraylist.YuansjHashMap<>();
    ...
    yuansjMap = new org.practise.map.hashmap.achieve.linkedlist.YuansjHashMap<>();
    ...
    yuansjMap = new org.practise.map.hashmap.YuansjHashMap<>();
    yuansjMap.put("a", "测试A");
